function [ COORDINATES, change_map ] = shearlet_detect_points_new( video, coeffs, scales, weights, min_threshold, spt_window, cone_weights, pause_between_frames, output_filename)
%SHEARLET_DETECT_POINTS_NEW Detects a set of spatio-temporal interest points in
...
[i, j, k] = shearlet_local_maxima_in_3D_matrix(change_map, min_threshold, spt_window, size(video));
